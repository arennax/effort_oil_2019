...
df15_MRE = [x/1-0.1 for x in df15_MRE]
...
plt.figure(1)
# plt.subplot(1, 2, 1)
plt.title('MRE (smaller is better)')
# plt.plot(df10_MRE)
plt.plot(df11_MRE)
plt.plot(df12_MRE)
plt.plot(df13_MRE)
...
plt.legend(['MPDE', 'FiADE', 'DE_OLD', 'SaMDE'], loc='lower right', fontsize = 'small')
# plt.xlabel('Dataset: desharnais', fontsize=30)
# plt.show()

# plt.subplot(1, 2, 2)
# plt.title('Larger is better')
# plt.plot(df10_SA)
# plt.plot(df11_SA)
# plt.plot(df12_SA)
# plt.plot(df13_SA)
